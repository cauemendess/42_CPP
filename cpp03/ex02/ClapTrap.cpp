...
{
    std::cout << "A default ClapTrap with no name was created with " 
...
void ClapTrap::attack(const std::string &target)
{
	...
	std::cout << "ClapTrap " << this->_name << " attacks " 
			<< target << ", causing " 
			<< this->_attackDamage << " points of damage and now has " 
